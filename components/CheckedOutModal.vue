<template>
  ...
  <!-- <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#checkedOut">
    Launch demo modal
  </button> -->

  <!-- Modal -->
  <div class="modal fade" id="checkedOut" tabindex="-1" aria-labelledby="checkedOutLabel" aria-hidden="true">
